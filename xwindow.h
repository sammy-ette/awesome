...
awesome_skia_image_t *xwindow_get_shape(xcb_window_t, enum xcb_shape_sk_t);
void xwindow_set_shape(lua_State *, int, xcb_window_t, int, int,
                       enum xcb_shape_sk_t, int);
